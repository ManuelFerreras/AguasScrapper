            ...
            <div className={`${styles.clientsTable}`}>
                {
                    clientsData.map((client, index) => {
                        return <ClientCard key={index} client={client} variant={index % 2 === 0? VariantEnum.primary : VariantEnum.secondary} />
                    })
                }
                
                <IconButton><Image src={'img/icon/addIcon.svg'} width={24} height={24} alt='Add' /></IconButton>
